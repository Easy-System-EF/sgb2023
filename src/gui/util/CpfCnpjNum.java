 ...
 *  if (CpfCnpj.Cpf(flagv, cpfV) == false) => INV�LIDO 
 *  if (CpfCnpj.Cnpj(flagv, cpfV) == false) => INV�LIDO 
 */		
 
public class CpfCnpjNum {
	...
	static String[] numeral = new String[10];
...
//		0 11; 1 10; 2 9; 3 8; 4 7; 5 6; 6 5; 7 4; 8 3; 9 2; 10 1; 11 0 
	...
	public static String confereNumeral(String num) {
		a = 0;
	...
	public static String confereZero(String num) {
		a = 0;
		for (i = 0 ; i < num.length() ; i++) {
			char c = num.charAt(i);
			if (c != '0' ) {
