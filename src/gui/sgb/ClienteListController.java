...
// c/ entidade e coluna	
 	...
 	@FXML
 	private TableColumn<Cliente, Double> tableColumnDddCli;

 	@FXML
 	private TableColumn<Cliente, Integer> tableColumnTelefoneCli;
...
// instanciando novo obj depto e injetando via
 		 ...
 		 createDialogForm(obj, "/gui/sgb/ClienteForm.fxml", parentStage);
   	}
...
// comportamento padr�o para iniciar as colunas 	
 	private void initializeNodes() {
		...
		tableColumnDddCli.setCellValueFactory(new PropertyValueFactory<>("dddCli"));
		tableColumnTelefoneCli.setCellValueFactory(new PropertyValueFactory<>("telefoneCli"));
		  ...
		  tableColumnEDITA.setCellFactory(param -> new TableCell<Cliente, Cliente>() { 
		    ...
		    protected void updateItem(Cliente obj, boolean empty) { 
		      ...
		      event -> createDialogForm( 
		        obj, "/gui/sgb/ClienteForm.fxml",Utils.currentStage(event)));
 		    } 
		  }); 
		}
